...
(
  ...
  TIM_MONTH_NAME        VARCHAR2(3 BYTE),
...
CREATE INDEX DIM_TIME_INDEX1 ON DIM_TIME
(TIM_DAY_IN_WEEK_NUM)
NOLOGGING
NOPARALLEL;


CREATE INDEX DIM_TIME_INDEX2 ON DIM_TIME
(TIM_DAY_IN_MONTH_NUM)
NOLOGGING
NOPARALLEL;


CREATE INDEX DIM_TIME_INDEX3 ON DIM_TIME
(TIM_DAY_IN_YEAR_NUM)
NOLOGGING
NOPARALLEL;


CREATE INDEX DIM_TIME_INDEX4 ON DIM_TIME
(TIM_WEEK_IN_YEAR_NUM)
NOLOGGING
NOPARALLEL;
...
CREATE INDEX DIM_TIME_INDEX6 ON DIM_TIME
(TIM_QUARTER_NUM)
NOLOGGING
NOPARALLEL;


CREATE INDEX DIM_TIME_INDEX7 ON DIM_TIME
(TIM_WEEKEND_FLAG)
NOLOGGING
NOPARALLEL;


CREATE INDEX DIM_TIME_INDEX8 ON DIM_TIME
(TIM_BUSINESS_DAY)
NOLOGGING
NOPARALLEL;


CREATE INDEX DIM_TIME_INDEX9 ON DIM_TIME
(TIM_MONTH_END_FLAG)
NOLOGGING
NOPARALLEL;
